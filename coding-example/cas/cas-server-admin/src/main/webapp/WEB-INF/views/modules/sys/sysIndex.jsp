	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://kaikeba.com" target="_blank">kaikeba</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
