...
public class AlipayNotify
{
    ...
    private static boolean getSignVeryfy(Map<String, String> Params, String sign)
    {
        ...
        String sign_type = Global.getConfig("sign_type");
        if(sign_type.equals("MD5"))
        {
            isSign = MD5.verify(preSignStr, sign, Global.getConfig("key"), Global.getConfig("input_charset"));
        }
        return isSign;
    }
    ...
    private static String verifyResponse(String notify_id)
    {
        ...
        String partner = Global.getConfig("partner");
