...
import com.thinkgem.jeesite.modules.zxy.utils.httpClient.HttpProtocolHandler;
import com.thinkgem.jeesite.modules.zxy.utils.httpClient.HttpRequest;
import com.thinkgem.jeesite.modules.zxy.utils.httpClient.HttpResponse;
import com.thinkgem.jeesite.modules.zxy.utils.httpClient.HttpResultType;
...
public class AlipaySubmit
{
    ...
    private static final String sign_type = Global.getConfig("sign_type");
    
    private static final String key = Global.getConfig("key");
    
    private static final String input_charset = Global.getConfig("input_charset");
    
    private static final String partner = Global.getConfig("partner");
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName)
    {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\"  enctype=\"multipart/form-data\" action=\"" + ALIPAY_GATEWAY_NEW + "_input_charset=" + input_charset + "\" method=\"" + strMethod + "\">");
