package com.xbao.cas.authentication.handler;
 ...
 *
 */
public class SxdPasswordEncoder implements PasswordEncoder{
    ...
    public SxdPasswordEncoder(final String encodingAlgorithm,final Integer hashInterations) {
